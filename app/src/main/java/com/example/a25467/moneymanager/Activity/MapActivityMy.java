...
public class MapActivityMy extends Activity implements GeoFenceListener,AMap.OnMapClickListener,
   ...
   /* public AMapLocationClient mLocationClient = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      LocationManager   locationManager=(LocationManager)getSystemService(Context.LOCATION_SERVICE);
        if (!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)&&!locationManager.isProviderEnabled(LocationManager
            ...
            dialog.setMessage("为了能您的位置，请先打开GPS。");
            dialog.setPositiveButton("设置",new android.content.DialogInterface.OnClickListener(){
                @Override
                public void  onClick(DialogInterface arg0,int arg1){
                    //转到手机设置界面，用户设置GPS
                    Intent intent=new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS);
                    Toast.makeText(MapActivityMy.this,"打开后点击右上角图标即可切换到所在位置",Toast.LENGTH_SHORT).show();
       ...
       locate_sure.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               if (tvresult.getText()!=""){
                   ...
                   Toast.makeText(MapActivityMy.this,"请选择地点。",Toast.LENGTH_SHORT).show();
               }
           }
       });
       locate_quit.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               finish();
           }
       ...
       if (ContextCompat.checkSelfPermission(MapActivityMy.this, Manifest.permission.ACCESS_FINE_LOCATION)
               != PackageManager.PERMISSION_GRANTED){
           permissionList.add(Manifest.permission.ACCESS_FINE_LOCATION);
       }
       if (ContextCompat.checkSelfPermission(MapActivityMy.this,Manifest.permission.READ_PHONE_STATE)
               !=PackageManager.PERMISSION_GRANTED){
           permissionList.add(Manifest.permission.READ_PHONE_STATE);
       }
       if (ContextCompat.checkSelfPermission(MapActivityMy.this,Manifest.permission.WRITE_EXTERNAL_STORAGE)
               !=PackageManager.PERMISSION_GRANTED){
           permissionList.add(Manifest.permission.WRITE_EXTERNAL_STORAGE);
       }
       if (!permissionList.isEmpty()){
           String[]permissions=permissionList.toArray(new String[permissionList.size()]);
           ActivityCompat.requestPermissions(MapActivityMy.this,permissions,1);
       }
       else {
    ...
    private  Handler handler=new Handler(){
        public void handleMessage(Message msg){
            switch (msg.what){
                case UPDATE_MAP:
                    aMap.setOnMapClickListener(MapActivityMy.this);
                    aMap.setLocationSource(MapActivityMy.this);//设置定位监听
                    //蓝点初始化
